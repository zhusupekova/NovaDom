    ...
    <main>
      <section className="hero">
        <nav className="nav" aria-label="Основная навигация">
          ...
          <a className="phone" href="tel:+996555123456">
            +996 555 123 456
          </a>
        </nav>
        ...
        <div className="hero-grid" id="top">
          <div className="hero-copy">
            <p className="eyebrow">Бишкек и Чуйская область</p>
      ...
      <section className="prices" id="prices">
        ...
        <div className="price-table" role="table" aria-label="Пакеты ремонта">
          {[
            ["Базовый", "от 3 500 сом/м²", "Обновить отделку без перепланировки"],
            ["Комфорт", "от 5 500 сом/м²", "Сделать квартиру готовой к переезду"],
            ["Капитальный", "от 7 500 сом/м²", "Заменить инженерные системы и отделку"],
            ["Дизайнерский", "от 11 000 сом/м²", "Реализовать проект с авторским надзором"],
          ].map(([name, price, text]) => (
      ...
      <section className="faq">
        ...
        {[
          [
            ...
            "Предварительно от 3 500 сом/м². Точная цена зависит от площади, состояния квартиры, класса материалов и инженерных работ.",
          ],
          [
      ...
      <div className="mobile-cta" aria-label="Быстрые действия">
        ...
        <a href="tel:+996555123456">Позвонить</a>
      </div>
    </main>
  );
}
